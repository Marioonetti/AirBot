...
@Composable
fun ChatScreen(onNavigate: (UiEvent.Navigate) -> Unit, channelId: String) {
    ...
    val listViewModel: MessageListViewModel = hiltViewModel()
    val attachmentsPickerViewModel: AttachmentsPickerViewModel = hiltViewModel()
    val composerViewModel: MessageComposerViewModel = hiltViewModel()
    ...
    MyOwnCustomScreen( listViewModel,
